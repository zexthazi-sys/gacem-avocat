...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .nav-blog { border: 1px solid rgba(45,63,92,0.22); border-radius: 20px; padding: 5px 12px; background: rgba(45,63,92,0.04); white-space: nowrap; transition: color 0.2s, background 0.25s, border-color 0.25s; }
